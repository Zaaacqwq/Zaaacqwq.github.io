...
export const processRemark = {
  processCode: function (node: any, parent: any, index: any) {
    ...
    const newNode = {
      type: "html",
      value: `<div class='code-block'><div class='code-head'><div class="code-expand" onclick="zac.toggleCollapse(this)"><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><path fill="currentColor" d=\"M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z\"/></svg></div><div class='code-lang'>${lang}</div></div>
  ...
  const html = renderToHtml(tokens, {
    ...
    elements: {
      pre({ className, style, children }) {
        className = className.replace(/shiki/g, "zac-code");

        style +=
          '; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;"';

        return `<div class='code-wrap ${theme}'><pre class="${className}" style="${style}" tabindex="0">${children}</pre><div class='code-copy' style='color: ${options[theme].fg};' title='copy code' onclick='zac.copyCode(this)'><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><path fill="currentColor" d=\"M272 0H396.1c12.7 0 24.9 5.1 33.9 14.1l67.9 67.9c9 9 14.1 21.2 14.1 33.9V336c0 26.5-21.5 48-48 48H272c-26.5 0-48-21.5-48-48V48c0-26.5 21.5-48 48-48zM48 128H192v64H64V448H256V416h64v48c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V176c0-26.5 21.5-48 48-48z\"/></svg></div></div>`;
      },
      code({ children }) {
